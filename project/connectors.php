...
?>
 <form action="./connectors.php" class="form-inline mt-2 mt-md-0">
	...
	<div style="padding: 10px 0px 10px 0px; vertical-align: text-bottom;">
		<span style="font-size: 125%;">connectors</span>
		<button class="button float-right edit_user" id="0">Add connector</button>
	</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.edit_user').click(function(event) {
			window.location.href = "editconnector.php?id="+$(this).attr('id');
		});
	
		$('.delete_user').click(function(){
			var anchor = $(this);
			$.ajax({
				url: './controllers/Connector_controller.php',
				type: 'GET',
				dataType: 'json',
